...
TemplateMo 603 MR BLACK KILLER

https://templatemo.com/tm-603-MR-BLACK-KILLER
...
(function () {
  if (typeof emailjs !== "undefined") {
    emailjs.init({ publicKey: "fWhCXXroEmbxJNeZ7" });
  }
})();
...
if (contactForm) {
  contactForm.addEventListener("submit", function (event) {
    ...
    if (!name || !email || !message) {
      statusEl.textContent = "Tafadhali jaza Jina, Email na Ujumbe.";
      statusEl.style.color = "#ff6b6b";
      return;
    }

    if (typeof emailjs === "undefined") {
      statusEl.textContent = "Imeshindikana kutuma. Tafadhali jaribu tena baadaye.";
      statusEl.style.color = "#ff6b6b";
      return;
    }
    ...
    emailjs.sendForm("service_lun3fdj", "template_6qa60mq", contactForm).then(
      ...
      (error) => {
        ...
        statusEl.textContent =
          ...
          (error && error.text ? error.text : "Unknown error");
        statusEl.style.color = "#ff6b6b";
        btn.disabled = false;
        btn.textContent = originalText;
      },
